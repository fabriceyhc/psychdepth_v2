...
## File Links
```
Since the json files created for the codeforces dataset were huge (>500 MG), the codeforces_ai_cots.json and codeforces_human_cots.json files are uploaded here:
