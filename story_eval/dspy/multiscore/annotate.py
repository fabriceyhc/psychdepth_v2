...
def main():
    ...
    try:
        ...
        # Save results
        pd.DataFrame(results).to_csv(f"./story_eval/dspy/multiscore/optimized_prompts/{model_id}/summary.csv")
...
if __name__ == "__main__":
    # CUDA_VISIBLE_DEVICES=1,2 python -m story_eval.dspy.multiscore.annotate
    main()