...
# CUDA_VISIBLE_DEVICES=0,2,3,5 python -m story_eval.dspy.multiscore.annotate --strategy ./story_eval/dspy/multiscore/optimized_prompts/meta-llama/Llama-3.1-70B-Instruct/MIPROv2_Predict-PsychDepthAssessment_handpicked-demos=10_persona.json
python -m story_eval.dspy.multiscore.annotate --strategy ./story_eval/dspy/multiscore/optimized_prompts/meta-llama/Llama-3.1-70B-Instruct/MIPROv2_Predict-PsychDepthAssessment_handpicked-demos=7_persona.json \
     --dataset /data2/yihewang/psychdepth_v2/dataset/data/gsm8k/shuffled.csv \
     --output /data2/yihewang/psychdepth_v2/dataset/data/gsm8k/score_shuffled.csv