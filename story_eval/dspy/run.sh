...
CUDA_VISIBLE_DEVICES=3 python -m story_eval.dspy.multiscore.annotate --strategy ./story_eval/dspy/multiscore/optimized_prompts/deepseek-ai/DeepSeek-R1-Distill-Llama-8B/MIPROv2_ChainOfThought-PsychDepthAssessment_handpicked-demos=5_persona.json
