...
CUDA_VISIBLE_DEVICES=4,5 python -m story_eval.dspy.multiscore.annotate  --model_id deepseek-ai/DeepSeek-R1-Distill-Llama-8B
...
# CUDA_VISIBLE_DEVICES=4,5 python -m story_eval.dspy.multiscore.annotate  --model_id deepseek-ai/DeepSeek-R1-Distill-Llama-70B