...
if __name__ == "__main__":
    ...
    average_scores = {
        int(idx): {
            ...
            "emotion_provoking_score": values["average"]["emotion_provoking_score"],
            "empathy_score": values["average"]["empathy_score"],
            "engagement_score": values["average"]["engagement_score"],
